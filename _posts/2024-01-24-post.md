...
P.S. 3: You can find Github with necessary files used for this tutorial on my [Github](https://github.com/TGusciora/001_Post_KickAssContainer). Be mindful that you will have to copy repository contents to "C:\AwesomeFolder\KickAssContainer" to make codes working.