...
<h3 id="h3"> III. Create Dockerfile </h3>
...
You might notice that I don't have PyPortfolioOpt specified here. That's because I directly ask pip to install this package in <a href="#3">III. Create Dockerfile</a> section.
